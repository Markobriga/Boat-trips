...
const Sidebar = () => {
    ...
    return (
        <div className="flex flex-col">
            <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" className="inline-flex  w-10 p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
            ...
            <aside id="default-sidebar" className="fixed top-0 left-0 z-40 h-screen md:relative md:h-auto w-64 transition-transform -translate-x-full md:translate-x-0" aria-label="Sidebar">
