    ...
    return (
        <div className="flex items-center justify-center h-screen">
            <div>
                ...
                <p>You have successfully booked a trip.</p>
                <Link
                    to="/"
                    className="inline-flex items-center px-4 py-2 text-white bg-primary-700 border border-primary-700 rounded-md focus:outline-none focus:ring">
