...
const { newBookerReservation, getBookerReservations, getAllTripsReservations } = require('../controllers/bookerReservationController');
...
router.route('/owner/reservations/:id').get(isAuthenticatedUser, authorizeRoles('owner'), getAllTripsReservations)
